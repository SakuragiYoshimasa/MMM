...
namespace MAPS {
	...
	public class Maps {
		...
		public MapsMesh generateBaseDomain(Mesh origMesh, List<int> featurePoints){
			mesh = origMesh;
			mmesh = MapsUtility.TransformMesh2MapsMesh(ref origMesh, 0);
			mmesh.featurePoints = featurePoints;
			while(levelDown()){}
			return mmesh;
		}
